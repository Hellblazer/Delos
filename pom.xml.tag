<project xmlns="http://maven.apache.org/POM/4.0.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://maven.apache.org/POM/4.0.0 http://maven.apache.org/xsd/maven-4.0.0.xsd">
    ...
    <name>Delos Umbrella App</name>

    <modules>
        <module>h2-deterministic</module>
        <module>fireflies</module>
        <module>protocols</module>
        <module>sql-state</module>
        <module>memberships</module>
        <module>tron</module>
        <module>stereotomy</module>
        <module>ethereal</module>
        <module>choam</module>
        <module>model</module>
        <module>delphinius</module>
        <module>schemas</module>
        <module>stereotomy-services</module>
        <module>thoth</module>
        <module>liquibase-deterministic</module>
        <module>grpc</module>
        ...
        <module>domain-sockets</module>
        <module>leyden</module>
        <module>vm-socket</module>
        <module>java-noise</module>
    ...
    <properties>
        ...
        <graal.vm.version>24.0.2</graal.vm.version>
    ...
    <dependencyManagement>
        <dependencies>
            ...
            <dependency>
                <groupId>com.hellblazer.delos</groupId>
                <artifactId>delphinius</artifactId>
                <version>${project.version}</version>
            </dependency>
            <dependency>
                <groupId>com.hellblazer.delos</groupId>
    ...
    <scm>
        <connection>scm:git:https://github.com/Hellblazder/delos.git</connection>
        <developerConnection>scm:git:https://github.com/Hellblazer/delos.git</developerConnection>
        <url>https://https://github.com/Hellblazer/delos</url>
        <tag>delos.app-0.0.6</tag>
    </scm>
    <repositories>
        <repository>
            <id>central</id>
                ...
                <plugin>
                    ...
                    <executions>
                        <execution>
                            ...
                            <configuration>
                                <sources>
                                    ...
                                    <source>
                                        ${project.basedir}/target/generated-sources/protobuf/java
                                    </source>
                                    <source>
                        ...
                        <execution>
                            ...
                            <configuration>
                                <sources>
                                    <source>${project.basedir}/src/test/proto</source>
                                    <source>
                                        ${project.basedir}/target/generated-test-sources/protobuf/grpc-java
                                    </source>
                                    <source>
                                        ${project.basedir}/target/generated-test-sources/protobuf/java
                                    </source>
                                    <source>
                                        ${project.basedir}/target/generated-test-sources/jooq
                                    </source>
                                </sources>
                            </configuration>
                        </execution>
                ...
                <pluginManagement>
                    <plugins>
                        <plugin>
                            ...
                            <configuration>
                                <argLine>
                                    -agentlib:native-image-agent=config-merge-dir=src/main/resources/META-INF/native-image,access-filter-file=src/test/resources/filter.json,caller-filter-file=src/test/resources/filter.json
                                </argLine>
                            </configuration>
                        </plugin>
                        <plugin>
