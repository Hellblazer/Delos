...
/**
 * Micrometer implementation of GorgoneionMetrics.
 *
 * @author hal.hildebrand
 */
public class MicrometerGorgoneionMetrics extends MicrometerEndpointMetrics implements GorgoneionMetrics {
    ...
    public MicrometerGorgoneionMetrics(MeterRegistry registry) {
        this(registry, "gorgoneion");
    }

    public MicrometerGorgoneionMetrics(MeterRegistry registry, String prefix) {
