# java-noise
_(Please note that this module is a mirror of the [java-noise repository of Jason Chambers](https://github.com/jchambers/java-noise).  This is temporary until that reposority is published in a maven repository)_
