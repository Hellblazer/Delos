...
public class RotationEventImpl extends EstablishmentEventImpl implements RotationEvent {
    ...
    final com.hellblazer.delos.stereotomy.event.proto.RotationEvent event;

    public RotationEventImpl(com.hellblazer.delos.stereotomy.event.proto.RotationEvent event) {
    ...
    public com.hellblazer.delos.stereotomy.event.proto.RotationEvent toRotationEvent_() {
        return event;
    }
