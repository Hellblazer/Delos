...
public class AttachmentEventImpl implements AttachmentEvent {
    ...
    private final com.hellblazer.delos.stereotomy.event.proto.AttachmentEvent event;

    public AttachmentEventImpl(com.hellblazer.delos.stereotomy.event.proto.AttachmentEvent event) {
        this.event = event;
    }
    ...
    @Override
    public com.hellblazer.delos.stereotomy.event.proto.AttachmentEvent toEvent_() {
        return event;
    }
