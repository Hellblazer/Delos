...
public class InteractionEventImpl extends KeyEventImpl implements InteractionEvent {
    ...
    private final com.hellblazer.delos.stereotomy.event.proto.InteractionEvent event;

    public InteractionEventImpl(com.hellblazer.delos.stereotomy.event.proto.InteractionEvent event) {
