...
public interface Verifiers {
    ...
    static Verifiers fromEventState(List<com.hellblazer.delos.stereotomy.event.proto.InceptionEvent> states) {
    ...
    class FixedVerifiers implements Verifiers {
        ...
        Collection<com.hellblazer.delos.stereotomy.event.proto.InceptionEvent> states) {
